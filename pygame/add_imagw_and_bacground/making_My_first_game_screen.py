...
pn=x.transform.scale(x.image.load("start.jpeg").convert_alpha(),(200,200))
...
x.draw.rect(screen,x.Color("red"),(pn_rect.x-10,pn_rect.y-10,pn_rect.width+20,pn_rect.height+20),3)
def game():
    clock=x.time.Clock()
    running=True
    while running:
