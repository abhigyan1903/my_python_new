...
bg=pygame.transform.scale(pygame.image.load("bg.jpg").convert(),(screen_width,screen_height))
pn=pygame.transform.scale(pygame.image.load("pn.png").convert_alpha(),(200,200))
